...
function sunset_load_admin_scripts( $hook ){
	...
	$pages_array = array(
		'toplevel_page_shabayekdes_sunset',
		'sunset_page_shabayekdes_sunset_theme',
		'sunset_page_shabayekdes_sunset_theme_contact',
		'sunset_page_shabayekdes_sunset_css'
	);
	...
	if ( 'sunset_page_shabayekdes_sunset_css' == $hook ){
